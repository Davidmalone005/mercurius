...
const Avatar = ({ src, alt, isHeader }) => {
  ...
  return (
    <section className={`flex items-center justify-center`}>
      {isHeader && (
        <p className="w-[40px] h-[40px] rounded-full shadow-md mr-1 border-[1px] border-primary grid place-items-center text-[15px] font-dalek bg-gray-50 dark:text-black">
          {userInitials}
        </p>
      )}
    </section>
