            ...
            if (window.localStorage.getItem("UserData")) {
              ...
              if (user.id) {
                ...
                if (addresses.length > 0) {
                  ...
                  const pk = pathnameArr[pathnameArr.length - 1];
                  ...
                  >
                    <section className="">
                      ...
                      <section className="flex items-center justify-between relative mt-1">
                        <input
                          ...
                          name="house_no"
                          placeholder={
                            oldAddress && oldAddress.house_no
                              ? oldAddress.house_no
                              : "1"
                          }
                          value={
                    ...
                    <section className="">
                      ...
                      <section className="flex items-center justify-between relative mt-1">
                        <input
                          ...
                          name="street_name"
                          placeholder={
                            oldAddress && oldAddress.street_name
                    ...
                    <section className="">
                      ...
                      <section className="flex items-center justify-between relative mt-1">
                        <input
                          ...
                          name="bus_stop"
                          placeholder={
                            oldAddress && oldAddress.bus_stop
                              ? oldAddress.bus_stop
                              : "Sili Bus Stop"
                          }
                          value={
                      ...
                      {errors.bus_stop &&
                        errors.bus_stop.type === "pattern" && (
                          <span className="text-red-500 block mt-2">
                            {errors.bus_stop.message}
                          </span>
                        )}
                      {errors.bus_stop &&
                        errors.bus_stop.type === "required" && (
                          <span className="text-red-500 block mt-2">
                            {errors.bus_stop.message}
                          </span>
                        )}
                    ...
                    <section className="">
                      ...
                      <section className="flex items-center justify-between relative mt-1">
                        <input
                          ...
                          name="lga"
                          placeholder={
                            oldAddress && oldAddress.lga
                              ? oldAddress.lga
                              : "Corn Valley"
                          }
                          value={
                            oldAddress && oldAddress.lga ? oldAddress.lga : ""
                          }
                          onChange={handleChange}
                          className={`appearance-none rounded-sm py-3 pl-5 w-full placeholder-[#868686] pr-12 text-black outline-none  dark:bg-white ${
                            errors.lga &&
                    ...
                    <section className="">
                      ...
                      <section className="flex items-center justify-between relative mt-1">
                        <input
                          ...
                          name="postal_code"
                          placeholder={
                            oldAddress && oldAddress.postal_code !== 0
                    ...
                    <section className="flex items-center justify-start">
                      ...
                      <input
                        ...
                        type="checkbox"
                        checked={oldAddress && oldAddress.is_default}
                        onChange={handleChange}
                        name="is_default"
                        id="is_default"
                      />
