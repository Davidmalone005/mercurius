...
const AccountDetails = ({}) => {
  ...
  const [dob, setdob] = useState("31/12/1975");

  useEffect(() => {
    if (
      (window.localStorage.getItem("UserData") && userStatus === "undefined") ||
  ...
  const formatDob = () => {
    if (userStatus && userStatus.dob) {
      ...
      const dobval = `${dobArr[2]}/${dobArr[1]}/${dobArr[0]}`;
                  ...
                  <section className="">
                    ...
                    >
                      <input
                        ...
                        name="dob"
                        placeholder={
                          userStatus && userStatus.dob ? formatDob() : dob
                        }
                        className={`form-control appearance-none rounded-sm py-3 pl-5 w-full placeholder-[#868686] pr-12 text-black outline-none transition ease-in-out dark:bg-white ${
                          errors.phone && "border-2 border-red-500 text-red-500"
